...
BROWSER_WORKER_PORT=3002 node /app/browser_worker.js >/tmp/browser-worker.log 2>&1 & PIDS="$PIDS $!"
...
BROWSER_WORKER_PORT=3001 BROWSER_WORKER_UPSTREAM_PORT=3002 node /app/worker_guard.js >/tmp/worker-guard.log 2>&1 & PIDS="$PIDS $!"
